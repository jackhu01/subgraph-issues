...
export class NewSafetyMargin__Params {
  ...
  get newSafetyMarginSqrt(): BigInt {
    return this._event.parameters[0].value.toBigInt();
  }
}
...
export class Collateral__getPricesResult {
  value0: BigInt;
  value1: BigInt;
...
export class Collateral__accountLiquidityAmountsResult {
  value0: BigInt;
  value1: BigInt;
...
export class Collateral__accountLiquidityResult {
  value0: BigInt;
  value1: BigInt;
...
export class Collateral extends ethereum.SmartContract {
  ...
  SAFETY_MARGIN_SQRT_MAX(): BigInt {
    let result = super.call(
      "SAFETY_MARGIN_SQRT_MAX",
      "SAFETY_MARGIN_SQRT_MAX():(uint256)",
      [],
    );
  ...
  try_SAFETY_MARGIN_SQRT_MAX(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "SAFETY_MARGIN_SQRT_MAX",
      "SAFETY_MARGIN_SQRT_MAX():(uint256)",
      [],
  ...
  SAFETY_MARGIN_SQRT_MIN(): BigInt {
    let result = super.call(
      "SAFETY_MARGIN_SQRT_MIN",
      "SAFETY_MARGIN_SQRT_MIN():(uint256)",
      [],
    );
  ...
  try_SAFETY_MARGIN_SQRT_MIN(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "SAFETY_MARGIN_SQRT_MIN",
      "SAFETY_MARGIN_SQRT_MIN():(uint256)",
      [],
  ...
  safetyMarginSqrt(): BigInt {
    let result = super.call(
      "safetyMarginSqrt",
      "safetyMarginSqrt():(uint256)",
      [],
    );
  ...
  try_safetyMarginSqrt(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "safetyMarginSqrt",
      "safetyMarginSqrt():(uint256)",
      [],
  ...
  getTwapPrice112x112(): BigInt {
    let result = super.call(
      "getTwapPrice112x112",
      "getTwapPrice112x112():(uint224)",
      [],
    );
  ...
  try_getTwapPrice112x112(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "getTwapPrice112x112",
      "getTwapPrice112x112():(uint224)",
      [],
  ...
  getPrices(): Collateral__getPricesResult {
    let result = super.call("getPrices", "getPrices():(uint256,uint256)", []);

    return new Collateral__getPricesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
    );
  }

  try_getPrices(): ethereum.CallResult<Collateral__getPricesResult> {
    let result = super.tryCall(
      "getPrices",
    ...
    return ethereum.CallResult.fromValue(
      new Collateral__getPricesResult(value[0].toBigInt(), value[1].toBigInt()),
    );
  }
  ...
  accountLiquidityAmounts(
    ...
    amount0: BigInt,
    amount1: BigInt,
  ): Collateral__accountLiquidityAmountsResult {
    let result = super.call(
      "accountLiquidityAmounts",
    ...
    return new Collateral__accountLiquidityAmountsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
    );
  }
  ...
  try_accountLiquidityAmounts(
    ...
    amount0: BigInt,
    amount1: BigInt,
  ): ethereum.CallResult<Collateral__accountLiquidityAmountsResult> {
    let result = super.tryCall(
      "accountLiquidityAmounts",
      "accountLiquidityAmounts(address,uint256,uint256):(uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Collateral__accountLiquidityAmountsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
      ),
    );
  ...
  accountLiquidity(borrower: Address): Collateral__accountLiquidityResult {
    let result = super.call(
      "accountLiquidity",
    ...
    return new Collateral__accountLiquidityResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
    );
  }
  ...
  try_accountLiquidity(
    borrower: Address,
  ): ethereum.CallResult<Collateral__accountLiquidityResult> {
    let result = super.tryCall(
      "accountLiquidity",
      "accountLiquidity(address):(uint256,uint256)",
      [ethereum.Value.fromAddress(borrower)],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Collateral__accountLiquidityResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
      ),
    );
...
export class _setSafetyMarginSqrtCall extends ethereum.Call {
  get inputs(): _setSafetyMarginSqrtCall__Inputs {
    return new _setSafetyMarginSqrtCall__Inputs(this);
  }

  get outputs(): _setSafetyMarginSqrtCall__Outputs {
    return new _setSafetyMarginSqrtCall__Outputs(this);
  }
}

export class _setSafetyMarginSqrtCall__Inputs {
  _call: _setSafetyMarginSqrtCall;

  constructor(call: _setSafetyMarginSqrtCall) {
    this._call = call;
  }
...
export class _setSafetyMarginSqrtCall__Outputs {
  _call: _setSafetyMarginSqrtCall;
...
export class GetTwapPrice112x112Call extends ethereum.Call {
  get inputs(): GetTwapPrice112x112Call__Inputs {
    return new GetTwapPrice112x112Call__Inputs(this);
  }

  get outputs(): GetTwapPrice112x112Call__Outputs {
    return new GetTwapPrice112x112Call__Outputs(this);
  }
}

export class GetTwapPrice112x112Call__Inputs {
  _call: GetTwapPrice112x112Call;

  constructor(call: GetTwapPrice112x112Call) {
    this._call = call;
  }
}

export class GetTwapPrice112x112Call__Outputs {
  _call: GetTwapPrice112x112Call;
