export const IMPERMAX_FACTORY_ADDRESS = '{{ impermaxFactory }}'.toLowerCase();
export const WETH_ADDRESS = '{{ weth }}'.toLowerCase();
export const STABLE_WETH_PAIR = '{{ stablePair }}'.toLowerCase();
export const UNISWAP_FACTORY_ADDRESS = '{{ uniswapFactory }}'.toLowerCase();
export const BLOCKS_PER_SECOND = '{{ blocksPerSecond }}';
export const IS_STABLE = false{{ stable }};
export const CREATE_UNDERLYING_PAIR = false;
export const UPDATE_FARM_ON_SYNC = true;
export const FAST_SYNC = false{{ fastSync }};
export let COLLATERALS: Array<string> = {{{ collaterals }}};
export let COLLATERAL_POSITIONS: Array<Array<string>> = {{{ collateralPositions }}};
export let BORROWABLES_BORROW: Array<string> = {{{ borrowablesBorrow }}};
export let BORROWABLES_BORROW_POSITIONS: Array<Array<string>> = {{{ borrowablesBorrowPositions }}};
export let BORROWABLES_SUPPLY: Array<string> = {{{ borrowablesSupply }}};
export let BORROWABLES_SUPPLY_POSITIONS: Array<Array<string>> = {{{ borrowablesSupplyPositions }}};
